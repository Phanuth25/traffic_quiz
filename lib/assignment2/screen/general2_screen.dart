...
import 'package:project2/assignment2/data/general2_data.dart';
import 'package:project2/assignment2/screen/result_screen.dart';
import 'package:project2/assignment2/screen/technical_screen.dart';
import 'package:project2/assignment2/data/notifier.dart';

class General2QuizScreen extends StatefulWidget {
  const General2QuizScreen({super.key});

  @override
  State<General2QuizScreen> createState() => _General2QuizScreenState();
}

class _General2QuizScreenState extends State<General2QuizScreen> {
  final PageController _pageController = PageController();
  int _currentIndex = 0;
  int?
  _selectedAnswerIndex; // NEW: tracks the chosen option (1, 2, or 3) for the active question
  final List<Question> _questions = QuizData.general2questions;
  ...
  void initState() {
    ...
    _randomizedQuestions.addAll(QuizData.general2questions);
