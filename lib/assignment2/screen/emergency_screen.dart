...
import 'package:project2/assignment2/data/emergency_data.dart';
import 'package:project2/assignment2/screen/priority_screen.dart';
import 'package:project2/assignment2/data/notifier.dart';

class EmergencyQuizScreen extends StatefulWidget {
  const EmergencyQuizScreen({super.key});

  @override
  State<EmergencyQuizScreen> createState() => _EmergencyQuizScreenState();
}

class _EmergencyQuizScreenState extends State<EmergencyQuizScreen> {
  final PageController _pageController = PageController();
  int _currentIndex = 0;
  int? _selectedAnswerIndex;
  final List<EmergencyQuestion> _questions = EmergencyQuizData.emergencyQuestions;
  ...
  void initState() {
    super.initState();
    _randomizedQuestions.addAll(EmergencyQuizData.emergencyQuestions);
                      ...
                      if (_selectedAnswerIndex != null) {
                        ...
                        if (_currentIndex == _questions.length - 1) {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PriorityQuizScreen(),
                            ),
                          );
                        } else {
                          _nextQuestion();
