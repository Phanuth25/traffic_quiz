...
import 'package:project2/assignment2/screen/emergency_screen.dart';
import 'package:project2/assignment2/data/technical_data.dart';
...
class _TechnicalQuizScreenState extends State<TechnicalQuizScreen> {
  ...
  void initState() {
    super.initState();
    _randomizedQuestions.addAll(TechnicalQuizData.technicalQuestions);
